...
async function testing(){
    ...
    let init = new Date('Apr-1-2021')
    let current = new Date()
    console.log(init.getDate, " ",current.getDate())
    console.log(init.getFullYear(), " ",current.getFullYear())
    // while(init.getDate != current.getDate() && init.getFullYear() != current.getFullYear()){
